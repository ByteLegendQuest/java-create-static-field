...
`git clone https://github.com/ByteLegendQuest/java-create-static-field`

A project directory named `java-create-static-field` will be created, which can be moved wherever you like.

Open `IDEA`, `File` - `Open`, select and open the `pom.xml` in `java-create-static-field` directory which is created just now.
